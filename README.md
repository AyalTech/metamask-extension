# AirMask Browser Extension

---

AirMask supports Firefox, Google Chrome, and Chromium-based browsers. We recommend using the latest available browser version.
...
- Copy the `.airmaskrc.dist` file to `.airmaskrc`
